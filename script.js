...
class Park extends Element{
    constructor(name, buildYear, area, numTrees) {
        ...
        this.area = area;
        this.numTress = numTrees;
    }
    
    treeDensity() {
        const density = this.numTress / this.area;
        console.log(`${this.name} has a tree desnsity of ${density} tress per square km.`);
    }
}
...
const allStreets = [new Street('Ocean Avenue', 1999, 1.1, 4),
                    ...
                    new Street('4th Street', 2015, 0.4),
                    new Street('Sunset Boulavard', 1982, 2.5, 5)
                  ];

function calc(arr) {
    
    const sum = arr.reduce((prev, cur, index) => prev + cur, 0);
    // [3, 5, 6] 0 + 3 = 3; 3 + 5 = 8; 8 + 6 = 14
...
function driversLicence6(passedTest) {
    ...
    // No longer access to vars inside block
    console.log(firstName + ', born in ' + yearOfBirth + ' is allowed to drive');
}
...
//ES5
/*
function SmithPerson(firstName, yearOfBirth, lastName, nationalality) {
    
    lastName === undefined ? lastName = 'Smith' : lastName = lastName;
    nationalality === undefined ? nationalality = 'American' : nationalality = nationalality;
